 ...
 * 
 */
package uvsoftgroup.uvsoftgroupjspwebapp.model;
...
public class UserRegistration implements Serializable{
	...
	@Id
	@GenericGenerator(name="seq_useregistration", strategy="uvsoftgroup.uvsoftgroupjspwebapp.utility.UserRegistrationIdGenerator")
